            ...
            <div class="breaking-box w-100">
                <marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseleave="this.start();">
                    @foreach ($data['posts_all'] as $post)
                        <a class="fw-bold breaking-main-text" href="{{ route('posts.show', ['slug' => $post->slug]) }}">
                            <span
                                class="position-relative mx-2 badge rounded-0 font-weight-bold breaking-main-category">{{ $post->category->name }}</span>
                            {{ $post->title }}
                        </a>
                    @endforeach
                </marquee>
        ...
        <div class="container mt-5">
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="form-check">
                            <input class="form-check-input filter-checkbox" type="checkbox"
                                value="{{ $type->id }}" id="checkboxPublicationType{{ $type->id }}">
            ...
            <table id="example" class="table table-striped table-borderless">
                <thead class="fw-bold custom-table-header">
                    <tr>
                        <th scope="col" data-column="publication_category_id" class="col-3 sortable">Publication
                            Type <i class="fa fa-sort"></i></th>
                        <th scope="col" data-column="title" class="col-6 sortable">Publication <i
                                class="fa fa-sort"></i></th>
                        <th scope="col" data-column="link" class="col-1 sortable">Link <i class="fa fa-sort"></i>
                        </th>
                        <th scope="col" data-column="year" class="col-2 sortable">Year <i class="fa fa-sort"></i>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($data['publications_data'] as $publication)
                        <tr>
                            ...
                            <td class="align-middle"><a href="{{ $publication->link }}" target="_blank"
                                    ...
                                    <button class="publication-doi-button">DOI</button></a></td>
...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="https://cdn.datatables.net/plug-ins/1.11.5/integration/bootstrap/4/dataTables.bootstrap4.min.css">
...
<body>
    <div class="container mt-5">
        <div class="row mb-3">
            @foreach ($data['publicationsCategory'] as $type)
                <div class="col-md-3 mb-3">
                    <div class="form-check">
                        <input class="form-check-input filter-checkbox" type="checkbox" value="{{ $type->id }}"
        ...
        <table id="example" class="table table-striped table-borderless">
            <thead class="fw-bold custom-table-header">
                <tr>
                    <th scope="col" data-column="publication_category_id" class="col-3 sortable">Publication Type <i
                            class="fa fa-sort"></i></th>
                    <th scope="col" data-column="title" class="col-6 sortable">Publication <i class="fa fa-sort"></i>
                    </th>
                    <th scope="col" data-column="link" class="col-1 sortable">Link <i class="fa fa-sort"></i></th>
                    <th scope="col" data-column="year" class="col-2 sortable">Year <i class="fa fa-sort"></i></th>
                </tr>
            </thead>
            <tbody>
                @foreach ($data['publications_data'] as $publication)
    ...
    <script type="text/javascript" charset="utf8"
        src="https://cdn.datatables.net/plug-ins/1.11.5/integration/bootstrap/4/dataTables.bootstrap4.min.js"></script>
    <!-- Custom Script -->
    <script>
        $(document).ready(function() {
            ...
            function filterTableRows() {
                ...
                table.rows().every(function(rowIdx, tableLoop, rowLoop) {
                    var publicationType = this.node().dataset.type;
